  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Welcome to GasLink - LPG Distribution Management</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="card p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Available Stock</p>
        ...
        <div className="card p-6">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">Action #{i}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Description of action</p>
                </div>
